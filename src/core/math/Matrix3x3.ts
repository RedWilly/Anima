...
export class Matrix3x3 {
  ...
  multiply(other: Matrix3x3): Matrix3x3 {
    ...
    // Asserting existence because Matrix3x3 guarantees 9 values.
  ...
  transformPoint(point: Vector2): Vector2 {
    ...
    // We ignore the z result (m[6]*x + m[7]*y + m[8]) as we project back to 2D w=1
    // For affine transforms, the last row is usually [0, 0, 1], so w=1 is preserved.
